...
public class StorageHelper {
    ...
    //object array
    private final ArrayList<UrlDataModel> note = new ArrayList<>();
    ...
    //constructor
    public StorageHelper(DatabaseReference reference) {
        this.reference = reference;
    }

    //returns true if data was entered into database else false
    public Boolean save(UrlDataModel notes) {
        if (notes == null) {
            saved = false;
        } else {
            try {
    ...
    public Boolean update(String key, UrlDataModel notes) {
        if (notes == null) {
            updated = false;
        } else {
            try {
    ...
    public ArrayList<UrlDataModel> retrieve() {
