...
public class FireBaseHelper {
    ...
    //object array
    private final ArrayList<ListSecDBModel> note = new ArrayList<>();
    ...
    public Boolean save(ListSecDBModel notes) {
        if (notes == null) {
            saved = false;
        } else {
            try {
    ...
    public Boolean update(String key, ListSecDBModel notes) {
        if (notes == null) {
            updated = false;
        } else {
            try {
    ...
    public ArrayList<ListSecDBModel> retrieve() {
