...
public class ProgrammingHelper {

    //reference to db
    private final DatabaseReference reference;

    //object array
    private final ArrayList<ProgrammingdbModel> note = new ArrayList<>();
    ...
    //constructor
    public ProgrammingHelper(DatabaseReference reference) {
        this.reference = reference;
    }

    //returns true if data was entered into database else false
    public Boolean save(ProgrammingdbModel notes) {
        if (notes == null) {
            saved = false;
        } else {
            try {
    ...
    public Boolean update(String key, ProgrammingdbModel notes) {
        if (notes == null) {
            updated = false;
        } else {
            try {
    ...
    public ArrayList<ProgrammingdbModel> retrieve() {
