...
public class mCalcFirebaseHelper {

    private final DatabaseReference reference;

    //object array
    private final ArrayList<mCalcdbModel> note = new ArrayList<>();
    ...
    //constructor
    public mCalcFirebaseHelper(DatabaseReference reference) {
        this.reference = reference;
    }

    //returns true if data was entered into database else false
    public Boolean save(mCalcdbModel notes) {
        if (notes == null) {
            saved = false;
        } else {
            try {
    ...
    public Boolean update(String key, mCalcdbModel notes) {
        if (notes == null) {
            updated = false;
        } else {
            try {
    ...
    public ArrayList<mCalcdbModel> retrieve() {
